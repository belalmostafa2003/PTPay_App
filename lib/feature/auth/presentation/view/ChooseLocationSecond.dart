...
class ChooseLocationSecond extends StatefulWidget {
  const ChooseLocationSecond({super.key});

  @override
  State<ChooseLocationSecond> createState() => _ChooseLocationSecondState();
}

class _ChooseLocationSecondState extends State<ChooseLocationSecond> {
  String? selectedRole;
